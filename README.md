...
**Current versions:** `grokSearch.user.js` **v1.75.0** · `grokPostSidebar.user.js` **v1.5.0**  
...
| **This repo** | — | Everything since: `grokSearch.user.js` v1.75.0 + `grokPostSidebar.user.js` v1.5.0 |
