...
**Current versions:** `grokSearch.user.js` **v1.68.3** · `grokPostSidebar.user.js` **v1.3.1**  
...
| **This repo** | Enhanced fork: `grokSearch.user.js` v1.68.3 + `grokPostSidebar.user.js` v1.3.1 |
