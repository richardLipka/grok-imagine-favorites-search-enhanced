...
**Current versions:** `grokSearch.user.js` **v1.69.2** · `grokPostSidebar.user.js` **v1.3.2**  
...
| **This repo** | — | Everything since: `grokSearch.user.js` v1.69.2 + `grokPostSidebar.user.js` v1.3.2 |
