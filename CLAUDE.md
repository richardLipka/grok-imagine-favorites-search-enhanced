...
| File | `@match` | Role |
|------|----------|------|
| `grokSearch.user.js` (v1.75.1, ~9.6k lines) | `https://grok.com/imagine*` (bails out on `/imagine/post/`) | Search bar, index + sync, results grid/panel, lightbox, context menu, bulk download, image metadata tagging |
