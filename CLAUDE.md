...
| File | `@match` | Role |
|------|----------|------|
| `grokSearch.js` (v1.62, ~4.7k lines) | `https://grok.com/imagine*` (bails out on `/imagine/post/`) | Search bar, index + sync, results grid/panel, lightbox, context menu, bulk download, EXIF tagging |
